...
# ssh root@45.141.79.54
# docker context create beget_dev --docker "host=ssh://root@45.141.79.54"

# ssh root@80.87.197.120
# docker context create binance --docker "host=ssh://root@80.87.197.120"
...
deploy_dev(){
  scp db.sql root@45.141.79.54:/root/db.sql
