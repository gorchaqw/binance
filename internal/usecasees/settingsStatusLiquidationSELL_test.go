...
type mockGenSettingsStatusLiquidationSELL struct {
...
func newMockGenSettingsStatusLiquidationSELL() *mockGenSettingsStatusLiquidationSELL {
	return &mockGenSettingsStatusLiquidationSELL{
		clientCtrl:   &ctrlMocks.ClientCtrl{},
		cryptoCtrl:   &ctrlMocks.CryptoCtrl{},
		tgmCtrl:      &ctrlMocks.TgmCtrl{},
		orderRepo:    &pgMocks.OrderRepo{},
...
func (mockGen *mockGenSettingsStatusLiquidationSELL) initLogger() {
	mockGen.logger = logrus.New()
	mockGen.logger.SetLevel(logrus.DebugLevel)
}

func (mockGen *mockGenSettingsStatusLiquidationSELL) run(t *testing.T) {
...
func (mockGen *mockGenSettingsStatusLiquidationSELL) clientMocks() {
...
func (mockGen *mockGenSettingsStatusLiquidationSELL) tgmMocks() {
	mockGen.tgmCtrl.On("Send", mock.AnythingOfType("string")).Return(nil)
}
func (mockGen *mockGenSettingsStatusLiquidationSELL) cryptoMocks() {
	mockGen.cryptoCtrl.On("GetSignature", mock.AnythingOfType("string")).Return("630e26f39d6728d0e7feffb9", nil)

}
func (mockGen *mockGenSettingsStatusLiquidationSELL) orderMocks() {
...
func (mockGen *mockGenSettingsStatusLiquidationSELL) settingsMocks() {
	mockGen.settingsRepo.On("UpdateStatus", mock.AnythingOfType("primitive.ObjectID"), structs.Enabled).
		Return(nil)
...
func (mockGen *mockGenSettingsStatusLiquidationSELL) initOrderUseCase() *orderUseCase {
...
func (mockGen *mockGenSettingsStatusLiquidationSELL) initPriceUseCase() *priceUseCase {
