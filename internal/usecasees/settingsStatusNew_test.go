...
type mockGenSettingsStatusNew struct {
...
func newMockGenSettingsStatusNew() *mockGenSettingsStatusNew {
	return &mockGenSettingsStatusNew{
		clientCtrl:   &ctrlMocks.ClientCtrl{},
		cryptoCtrl:   &ctrlMocks.CryptoCtrl{},
		tgmCtrl:      &ctrlMocks.TgmCtrl{},
		orderRepo:    &pgMocks.OrderRepo{},
...
func (mockGen *mockGenSettingsStatusNew) initLogger() {
	mockGen.logger = logrus.New()
	mockGen.logger.SetLevel(logrus.DebugLevel)
}

func (mockGen *mockGenSettingsStatusNew) run(t *testing.T) {
...
func (mockGen *mockGenSettingsStatusNew) clientMocks() {
...
func (mockGen *mockGenSettingsStatusNew) settingsMocks() {
...
func (mockGen *mockGenSettingsStatusNew) initOrderUseCase() *orderUseCase {
...
func (mockGen *mockGenSettingsStatusNew) initPriceUseCase() *priceUseCase {
